# Open Workflow Project Governance
...
For specific guidance on practical contribution steps for any Open Workflow sub-project please
...
Open Workflow subprojects all culminate in officially supported and
...
New subprojects can request to be added to the Open Workflow GitHub
...
If a project is approved, a maintainer will add the project to the Open Workflow
...
Open Workflow is an open-source project with an open design philosophy. This means
...
All decisions affecting Open Workflow, big and small, follow the same 3 steps:
